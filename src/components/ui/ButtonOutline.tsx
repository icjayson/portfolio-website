...
export const ButtonOutline: React.FC<ButtonOutlineProps> = ({
  ...
  const baseClasses = `
    ...
    shadow-[0_1px_0_rgba(0,0,0,0.5),inset_0_0_8px_2px_rgba(0,0,0,0.5)]
    hover:bg-transparent hover:shadow-[inset_0_0_12px_4px_rgba(0,0,0,0.5),0_1px_0_rgba(0,0,0,0.5)]
