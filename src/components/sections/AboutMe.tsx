...
import { Sparkles, Trophy, GraduationCap, Phone, Mail, CircleStar, Medal,  Linkedin } from 'lucide-react';
  ...
  const timelineData = [
    {
      ...
      description: 'Coordinated content strategies and managed copywriting projects for digital marketing campaigns.'
    },
        {
      ...
      description: 'Developed copywriting skills and performance marketing strategies for various client campaigns.'
    },
    {
      ...
      description: 'Led marketing initiatives and product development strategies for innovative tech solutions.'
    },
    {
      ...
      description: 'Complete brand identity redesign and performance optimization for established retail brand.'
    },
    {
      ...
      description: 'Specialized in SEO strategies and content planning for cloud technology services.'
    },
    {
      ...
      description: 'Developed integrated marketing communications and product development strategies.'
    },
    {
      role: 'Marketing Intern',
      ...
      description: 'Creating innovative digital experiences through user-centered design and development.'
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="space-y-8">
              {timelineData.map((item, index) => (
                ...
                >
                  ...
                  {/* Timeline Card */}
                  <GlassPanel className="ml-0 lg:ml-16 p-6 rounded-2xl hover:transform hover:scale-105 transition-all duration-300">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <GlassPanel className="p-6 rounded-2xl hover:transform hover:scale-105 transition-all duration-300">
